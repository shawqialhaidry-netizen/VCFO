...
_ADVISOR_LABELS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "rule3": "3. Explain what changed, why it changed, and how it compares with the prior period when that evidence exists",
        "rule4": "4. Give one concrete management step tied to the metrics above; never answer with generic filler",
