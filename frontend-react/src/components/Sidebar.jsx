...
const NAV = [
  { to: '/',           key: 'nav_dashboard',   icon: <IcoDash />,   accent: 'var(--accent)'  },
  { to: '/executive',  key: 'nav_executive',   icon: <IcoExec />,   accent: 'var(--green)'   },
  { to: '/upload',     key: 'nav_upload',       icon: <IcoUpload />, accent: 'var(--blue)'    },
  { to: '/statements', key: 'nav_statements',   icon: <IcoStmt />,   accent: 'var(--violet)'  },
  { to: '/analysis',   key: 'nav_analysis',     icon: <IcoPulse />,  accent: 'var(--amber)'   },
  { to: '/branches',    key: 'nav_branches',      icon: <IcoBranch />, accent: 'var(--accent)'  },
...
function IcoExec()    { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><circle cx="17.5" cy="17.5" r="3.5"/></svg> }
...
function IcoPulse()  { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> }
function IcoBranch() { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg> }
